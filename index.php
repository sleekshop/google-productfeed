...
if($action==1)
{
  if($remote_session=="")
  {
   ...
   echo "<h3>Welcome to the google-feed app for sleekshop (initial-setup) / v 1.0.0 beta</h3>";
   ...
   <hr>
   google category id<br>
   <input type='text' name='google_category_id' placeholder='google category id' value='".GOOGLE_CATEGORY_ID."'><br><br>
   Base URL<br>
 ...
 if($action==3)
  {
    ...
    ConfCtl::CreateConf($api_endpoint,$licence_username,$licence_password,$application_token,$base_url,$google_category_id);
    echo "<h3>Welcome to the google-feed app for sleekshop / v 1.0.0 beta</h3>";
