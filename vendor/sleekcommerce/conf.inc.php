...
public static function CreateConf($api_endpoint="",$licence_username="",$licence_password="",$application_token="",$base_url="",$google_category_id=0)
 {
   ...
   $res=str_replace("###GOOGLE_CATEGORY_ID###",$google_category_id,$res);
